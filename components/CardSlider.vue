        ...
        >
          ...
          <article class="bg-white p-6 rounded-lg shadow-2xl">
            ...
            <footer class="text-right">
              <div
                @click="navigateTo(`/Activities/${props.activities[0].activityId}/`)"
              >
                <a
                  @click="trackHistory(props.activities[0].activityId)"
        ...
        >
          ...
          <article class="bg-white p-6 rounded-lg shadow-2xl">
            ...
            <footer class="text-right">
              <div
                @click="
                  navigateTo(`/Activities/${props.activities[1].activityId}/`)
                "
              >
                <a
                  @click="trackHistory(props.activities[1].activityId)"
                  class="text-sm font-medium text-indigo-500 hover:underline"
                  >Read more</a
                >
              </div>
        ...
        >
          ...
          <article class="bg-white p-6 rounded-lg shadow-2xl">
            ...
            <footer class="text-right">
              <div
                @click="
                  navigateTo(`/Activities/${props.activities[2].activityId}/`)
                "
              >
                <a
                  @click="trackHistory(props.activities[2].activityId)"
                  class="text-sm font-medium text-indigo-500 hover:underline"
                  >Read more</a
                >
              </div>
        ...
        >
          ...
          <article class="bg-white p-6 rounded-lg shadow-2xl">
            ...
            <footer class="text-right">
              <div
                @click="
                  navigateTo(`/Activities/${props.activities[3].activityId}/`)
                "
              >
                <a
                  @click="trackHistory(props.activities[3].activityId)"
                  class="text-sm font-medium text-indigo-500 hover:underline"
                  >Read more</a
                >
              </div>
        ...
        >
          ...
          <article class="bg-white p-6 rounded-lg shadow-2xl">
            ...
            <footer class="text-right">
              <div
                @click="
                  navigateTo(`/Activities/${props.activities[4].activityId}/`)
                "
              >
                <a
                  @click="trackHistory(props.activities[4].activityId)"
                  class="text-sm font-medium text-indigo-500 hover:underline"
                  >Read more</a
                >
              </div>
