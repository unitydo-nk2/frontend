  ...
  >
    ...
    <div>
      ...
      <div class="flex">
        ...
        >
          <div
            class="flex text-indigo-600 text-base font-normal font-['DB Heavent'] leading-none"
          >
            <svg
              class="mr-4"
              width="11"
      ...
      <!-- ชื่อ activity -->
      <div
        class="m-4 text-neutral-100 text-2xl font-bold font-['DB Heavent'] leading-10 tracking-wide"
      >
        Youth Nique Camp 10: พัฒนาตัวเอง<br />และช่วยผู้พิการทางสายตาด้วยกัน
      </div>
      <!-- description -->
      <div
        class="m-4 w-96 text-neutral-100 text-base font-normal font-['DB Heavent'] leading-normal tracking-wide"
      >
        ค่ายอบรมอาสา สำหรับน้อง ๆ เรียนรู้การเข้าร่วมกิจกรรมอาสา
        ช่วยผู้พิการทางสายตา ให้มีมีชีวิตที่ดีขึ้น
        พร้อมรับการรับรองและชั่วโมงอาสา!
      </div>
      <!-- รายละเอียด -->
      <div>
        ...
        <div class="grid grid-cols-2 grid-rows-7">
          <div
            class="m-4 w-36 text-violet-100 text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
            ผู้จัดกิจกรรม
          </div>
          <div
            class="m-4 text-white text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
            We Volunteer Spirit Thailand
          </div>
          <div
            class="m-4 w-36 text-violet-100 text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
          ...
          <div
            class="m-4 w-24 text-violet-100 text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
            สถานที่
          </div>
          <div
            class="m-4 text-white text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
            โรงเรียนวัดหนองจอกใหญ อ.บางแค จังหวัดสระบุรี
          </div>
          <div
            class="m-4 w-24 text-violet-100 text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
          ...
          <div
            class="m-4 text-violet-100 text-base font-bold font-['DB Heavent'] leading-normal tracking-wide"
          >
            วันที่จัดกิจกรรม
          </div>
          <div
        ...
        <div class="flex">
          ...
          <button class="m-4 w-16 h-16 bg-white rounded-full">
            ...
            >
              <path
                d="M30 13.5L18.4 1V7.25C12.6 7.25 1 11 1 26C1 23.9161 4.48 19.75 18.4 19.75V26L30 13.5Z"
                fill="#5628FF"
                stroke="#5628FF"
                stroke-width="2"
                stroke-linecap="round"
