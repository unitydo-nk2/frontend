...
<template>
  <div class=" font-primary grid md:grid-cols-2 w-full h-auto bg-gradient-to-r from-slate-700 to-fuchsia-950">
    <div class="grid">
      <div class="m-4">
        <img class="h-full w-full" src="https://flowbite.s3.amazonaws.com/docs/gallery/featured/image.jpg" alt="" />
      </div>
      <div>
        <div class="m-4 flex gap-4">
          <div>
            <img class="h-32 w-full" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-1.jpg" alt="" />
          </div>
          <div>
            <img class="h-32 w-full" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg" alt="" />
          </div>
          <div>
            <img class="h-32 w-full" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-3.jpg" alt="" />
          </div>
          <div>
            <img class="h-32 w-full" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-4.jpg" alt="" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="flex">
        <div class="m-4 w-28 h-8 px-2.5 py-1 bg-white rounded-2xl justify-center items-center gap-2.5 inline-flex">
          <div class="flex text-indigo-600 text-base font-normal leading-none">
            ...
            <span v-if='activity.activityFormat == "onsite" || activity.activityFormat == "onsiteOverNight" '> On-site </span>
            <span v-else>online</span>
          </div>
        </div>
        <div v-if='activity.activityFormat == "onsiteOverNight"' class="m-4 w-60 h-8 px-2.5 py-1 bg-white rounded-2xl justify-center items-center gap-2.5 inline-flex">
          <div class="flex text-indigo-600 text-base font-normal leading-none">
      ...
      <!-- ชื่อ activity -->
      <div class="m-4 text-neutral-100 text-2xl font-bold leading-10 tracking-wide">
        {{ activity.activityName }}             {{activity.format}}

      </div>
      <!-- description -->
      <div class="m-4 w-96 text-neutral-100 text-base font-normal leading-normal tracking-wide">
      ...
      <div>
        ...
        <div class="grid grid-cols-2 grid-rows-7">
          <div class="m-4 w-36 text-violet-100 text-base font-bold leading-normal tracking-wide">
            ผู้จัดกิจกรรม
          </div>
          <div class="m-4 text-white text-base font-bold leading-normal tracking-wide">
          ...
          <div class="m-4 w-24 text-violet-100 text-base font-bold leading-normal tracking-wide">
            สถานที่
          </div>
          <div class="m-4 text-white text-base font-bold leading-normal tracking-wide">
          <div v-if="activity.locationName == null" >
            online activity
          </div>
          <div v-else>
          ...
          <div class="m-4 text-violet-100 text-base font-bold leading-normal tracking-wide">
            วันที่จัดกิจกรรม
          </div>
          <div class="m-4 text-white text-base font-bold leading-normal tracking-wide">
            24 พฤศจิกายน 2566
          ...
          <div class="m-4 text-white text-base font-bold leading-normal tracking-wide">
          {{ Date(activity.registerStartDate) }} - {{ Date(activity.registerEndStartDate) }}
          </div>
        </div>
        <div class="m-4 w-full h-px border border-neutral-50"></div>
        <!-- buttons -->
        <div class="flex">
          <nuxt-link :to="`/ActivityRegistration/${activity.activityId}`">
            <button class="m-4 w-28 h-14 bg-white rounded-xl border border-indigo-600">
              <div class="w-24 h-9 text-indigo-600 text-base font-bold leading-7 tracking-wide">
                สมัครเลย !
              </div>
            </button>
          </nuxt-link>
          <button class="m-4 w-48 h-14 bg-indigo-600 rounded-xl">
            <div class="w-40 text-white text-base font-bold leading-7 tracking-wide">
              คู่มือการสมัคร
            </div>
          </button>
